...
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_1.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_2.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_3.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_4.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_5.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_6.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_7.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_8.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_9.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_10.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_11.png'),
('https://ik.imagekit.io/alramadi/vheexa/website/assets/vehicle_12.png');
...
((SELECT "UUID" FROM "Images" OFFSET 0 LIMIT 1), (SELECT "UUID" FROM "Locations" OFFSET 0 LIMIT 1), 'user', '1990-01-01', '+10000000000', 'user@vheexa.com', 'AQAAAAIAAYagAAAAEE110qdoPdFA56+/BhahkESGi1susGSrN/oMVDGuSLctPVm0jWuG0kHaZwVB9XcHVw==');
...
((SELECT "UUID" FROM "Partners" OFFSET 0 LIMIT 1), (SELECT "UUID" FROM "Images" OFFSET 5 LIMIT 1), 'SUV C', 'Spacious SUV for family.', 'Ford', '2020-01-01', 'Automatic', 7, 'Diesel', 70.0, 0.1, ARRAY['suv','family'], TRUE, FALSE, NULL, NOW(), NOW()),
((SELECT "UUID" FROM "Partners" OFFSET 0 LIMIT 1), (SELECT "UUID" FROM "Images" OFFSET 6 LIMIT 1), 'Luxury D', 'Luxury sedan with comfort.', 'BMW', '2022-06-01', 'Automatic', 5, 'Petrol', 80.0, 0.15, ARRAY['luxury','sedan'], TRUE, FALSE, NULL, NOW(), NOW()),
...
((SELECT "UUID" FROM "Partners" OFFSET 0 LIMIT 1), (SELECT "UUID" FROM "Images" OFFSET 8 LIMIT 1), 'Convertible F', 'Convertible for summer.', 'Mercedes', '2020-05-01', 'Automatic', 2, 'Petrol', 90.0, 0.2, ARRAY['convertible','sport'], TRUE, FALSE, NULL, NOW(), NOW()),
