...
CREATE TABLE "Images" ("Id" TEXT PRIMARY KEY, "Url" TEXT NOT NULL);
...
CREATE TABLE "UserRefreshTokens" (
    ...
    "RefreshTokenUuid" UUID NOT NULL REFERENCES "RefreshTokens" ("Uuid")
);
