...
import { Section, Badge } from "@/components/blocks/typography";

import { Separator } from "@/components/shadcn/separator";
import { Skeleton } from "@/components/shadcn/skeleton";

export default function Overview() {
  const overviewService = useOverviewService();
  ...
  const {
    ...
    enabled: overviewService !== undefined,
    queryKey: ["overview"],
    queryFn: () => overviewService!.read(),
  });
