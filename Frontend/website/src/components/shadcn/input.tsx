  ...
  return (
    <input
      ...
      className={cn(
        ...
        "aria-invalid:caret-destructive/60 aria-invalid:text-destructive aria-invalid:placeholder:text-destructive/80 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className,
      )}
      {...props}
    />
